"""
Django settings for trustline_backend project.
...
SECRET_KEY = 'django-insecure-x2^mj@ii%e03xjw4f0c8o2-3%o%mg)t(ijtc1w-+icvm0%%2!s'
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_INACTIVE_REFRESH_LIFETIME': timedelta(days=1),
...
WSGI_APPLICATION = 'trustline_backend.wsgi.application'
